Attribute VB_Name = "LIB_ModulSlovimaIznos"
Option Compare Database
'Option Explicit

Global Const sep = ""

Function BL_SlovimaIznos(Iznos As Double) As String
...
SlovimaIznos = rez & dinslv & " i " & DoChLeft(Trim(stR(dec)), 2, "0") & "/100"
