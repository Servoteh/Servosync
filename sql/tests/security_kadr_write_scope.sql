...
SELECT is((SELECT count(*)::int FROM _u), 1,
...
SELECT is((SELECT count(*)::int FROM _u2), 0,
...
SELECT is((SELECT count(*)::int FROM _d1), 0,
...
SELECT is((SELECT count(*)::int FROM _de), 0,
...
SELECT is((SELECT count(*)::int FROM _u3), 1,
...
SELECT is((SELECT count(*)::int FROM _hr), 1,
...
SELECT is((SELECT count(*)::int FROM _ad), 1,
...
SELECT is((SELECT count(*)::int FROM _vw), 0,
...
SELECT is((SELECT count(*)::int FROM _vr), 1,
...
SELECT is((SELECT count(*)::int FROM _pm), 1,
...
SELECT is((SELECT count(*)::int FROM _hei), 1,
