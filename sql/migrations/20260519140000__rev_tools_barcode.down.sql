...
DROP FUNCTION IF EXISTS public.rev_tools_set_barcode();

DROP INDEX IF EXISTS ux_rev_tools_barcode;

ALTER TABLE public.rev_tools DROP COLUMN IF EXISTS barcode;

DROP SEQUENCE IF EXISTS public.rev_tools_barcode_seq;
