-- Pregled (Kadrovska): KPI „Aktivni zaposleni“ uvek firma-wide (is_active),
-- dok ostali KPI i dalje poštuju menadžment scope (odeljenja).
...
COMMENT ON FUNCTION public.kadr_dashboard_kpis(int, int) IS
  'JSON KPI za Kadrovska Pregled: active_employees uvek svi aktivni zaposleni; '
  'ostalo (odsustvo, GO, grid) i dalje po scope-u admin/HR/menadžment + managed_departments.';
