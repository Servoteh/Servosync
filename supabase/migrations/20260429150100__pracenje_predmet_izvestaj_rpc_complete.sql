-- Dopuna: kompletan get_predmet_pracenje_izvestaj + public wrapperi ako je prva primena bila skraćena.
-- Izvor: isti fajl kao 20260429140000 (helper + glavni RPC + NOTIFY).
