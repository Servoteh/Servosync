            ...
            AND (
              ...
              OR (
                ...
                AND (
                  ...
                  OR (
                    trim(pl.order_no) = '9400'
                    AND trim(pl.item_ref_id) ~ '^[0-9]+/[0-9]+$'
...
COMMENT ON FUNCTION public.loc_report_parts_by_locations IS
  'Lokacije v2: pregled placement-a + BigTehn meta; za 9400 + TP „x/y" ident može biti 9400-x/y; legacy kad item_ref počinje sa „-".';
