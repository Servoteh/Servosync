...
export function mapDbEmployee(d) {
  ...
  return {
    ...
    positionName: d.position_name || d.position || '',
    department: d.department || '',
    departmentId: d.department_id || null,
    departmentName: d.department_name || d.department || '',
    subDepartmentId: d.sub_department_id || null,
    subDepartmentName: d.sub_department_name || '',
    team: d.team || '',
...
export function buildEmployeePayload(emp) {
  ...
  const p = {
    ...
    sub_department_id: emp.subDepartmentId || null,
